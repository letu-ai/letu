...
namespace Letu.Logger
{
    ...
    public sealed class ExceptionLogFilter : IAsyncExceptionFilter
    {
        ...
        private readonly LetuLoggerOption _options;

        public ExceptionLogFilter(ICapPublisher capPublisher, ILogger<ExceptionLogFilter> logger, IOptions<LetuLoggerOption> options)
        {
