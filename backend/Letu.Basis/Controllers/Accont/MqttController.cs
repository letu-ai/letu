...
//    [HttpPost]
//    public async Task<MqttToken> GetMqttTokenAsync(string code)
//    {
...
//            if (ttl > 60)
//            {
//                return new MqttToken { Token = redisDb.Get<string>(codeKey), Expired = TimeHelper.Instance.GetCurrentTimestamp() + ttl };
//            }
//        }
...
//        return new MqttToken { Expired = expired, Token = token };
//    }
//}
