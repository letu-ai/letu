...
//             {
//                 //身份验证
//                 var userId = context.User.FindFirst(x => x.Type == AbpClaimTypes.UserId)?.Value;
...
//                 var isValid = await identityAppService.ValidateTokenAsync(userId!, sessionId!, requestToken);
//                 if (!isValid)
//                 {
...
//                 if (mustMain != null)
//                 {
//                     hasPower = await _identitySharedService.UserIsFromMainDbAsync(userId!);
//                 }
//                 if (hasPower && auth != null)
//                 {
//                     hasPower = await _identitySharedService.CheckPermissionAsync(userId!, auth.Code);
//                 }
