...
namespace Letu.Basis.Service.System
{
    public class ScheduledTaskAppService : IScheduledTaskAppService
    {
        ...
        public ScheduledTaskAppService(IRepository<ScheduledTaskDO> scheduledTaskRepository, IRepository<TaskExecutionLogDO> taskExecutionLogRepository, IJobControl jobControl)
        {
