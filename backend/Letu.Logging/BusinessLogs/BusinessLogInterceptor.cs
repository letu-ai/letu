...
public class BusinessLogInterceptor : AbpInterceptor, ITransientDependency
{
    private readonly IServiceScopeFactory serviceScopeFactory;
    private readonly IHttpContextAccessor? httpContextAccessor;
    private readonly ILocalEventBus localEventBus;
    private readonly ICurrentTenant currentTenant;
    private ILogger<BusinessLogInterceptor> logger;

    public BusinessLogInterceptor(
        IServiceScopeFactory serviceScopeFactory,
        IHttpContextAccessor? httpContextAccessor,
        ILocalEventBus localEventBus,
        ICurrentTenant currentTenant,
        ILogger<BusinessLogInterceptor> logger)
    {
    ...
    {
        var operationLogAttribute = invocation.Method.GetCustomAttribute<BusinessLogAttribute>();
        ...
        var logManager = serviceScope.ServiceProvider.GetRequiredService<IBusinessLogManager>();
    ...
    private async Task ProcessAsync(IAbpMethodInvocation invocation, IBusinessLogManager logManager, BusinessLogAttribute operationLogAttribute)
    {
    ...
    private async Task AfterAsync(IBusinessLogManager logManager, BusinessLogAttribute operationLogAttribute, long duration, Exception? exception = null)
    {
