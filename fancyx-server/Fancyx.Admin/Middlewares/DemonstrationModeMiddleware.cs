namespace Fancyx.Admin.Middlewares
{
    public class DemonstrationModeMiddleware
    {
        ...
        private AppResponse<bool> IsDemonstrationMode(HttpContext context)
        {
            ...
            var isWhite = !string.IsNullOrWhiteSpace(requestPath) && (requestPath.Contains("account/login") || requestPath.Contains("account/signout") || requestPath.Contains("account/refreshtoken") || requestPath.Contains("api/mqtt"));
