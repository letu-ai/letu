...
export function UserInfo() {
    ...
    return (
                ...
                <div>
                    <Card className="w-80 shadow-lg border border-gray-200" styles={{ body: { padding: "24px" } }}>
                        <div className="flex items-start gap-4 mb-4">
                            <Avatar size={48} src={`${getApiBaseUrl()}/api/my/profile/avatar`} icon={<img title="头像" src="/images/avatar/male.png" />} />
        ...
        >
            ...
            >
                <Avatar size={32} src={`${getApiBaseUrl()}/api/my/profile/avatar`} icon={<img title="头像" src="/images/avatar/male.png" />} />
