...
import { Form, Input, Checkbox, Button, Typography, Modal, InputNumber, Spin, App } from 'antd';
...
export const Route = createFileRoute('/admin/settings/emailing')({
...
function EmailSettings() {
    ...
    const handleShowTestEmailDialog = () => {
        // 在显示对话框时设置测试邮件表单的默认值
        testEmailForm.setFieldsValue({
            senderEmailAddress: form.getFieldValue('defaultFromAddress') || '',
            targetEmailAddress: "",
            subject: "邮件测试",
        ...
        <Spin spinning={pageLoading} tip="加载中...">
            ...
            >
                ...
                <div className="text-center mt-16">
                    <Button
                        style={{ marginRight: 8 }}
                        onClick={handleShowTestEmailDialog}
                    >
                        发送测试邮件
                    </Button>
