        ...
        <Spin spinning={pageLoading} tip="加载中...">
            ...
            >
                <div className="mb-6">
                    ...
                    >
                        {({ getFieldValue }) => {
                            const isSelfRegistrationEnabled = getFieldValue('isSelfRegistrationEnabled');
                            return (
                                <div className="flex flex-col gap-2 pl-8">
                                    <Form.Item
                                        className="mb-0"
                                        name="enableUserNameRegistration"
                                        valuePropName="checked"
                                    >
                                        <Checkbox disabled={!isSelfRegistrationEnabled}>
                                            允许使用用户名注册
                                        </Checkbox>
                                    </Form.Item>
                                    ...
                                    <Form.Item
                                        name="enablePhoneNumberRegistration"
                                        valuePropName="checked"
                                    >
                                        <Checkbox disabled={!isSelfRegistrationEnabled}>
                                            允许使用手机号码注册
                    ...
                    <Form.Item
                        name="enableUserNameLogin"
                        valuePropName="checked"
                    >
                        <Checkbox>允许用户名和密码登录</Checkbox>
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        valuePropName="checked"
                    >
                        <Checkbox>允许手机验证码登录</Checkbox>
                    </Form.Item>

                    <Form.Item
                        name="enablePhoneNumberLogin"
                        valuePropName="checked"
                    >
                        <Checkbox>允许邮箱验证码登录</Checkbox>
                    </Form.Item>
