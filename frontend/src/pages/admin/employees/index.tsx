...
import EmployeeForm, { type EmployeeModalRef } from './_EmployeeForm';
import type { SmartTableRef, SmartTableColumnType } from '@/components/SmartTable/type.ts';
import BindUserForm, { type BindUserFormRef } from './_BindUserForm';
    ...
    },
    {
      ...
      render: (_: any, record: EmployeeListDto) => (
        <Space>
          ...
          <Permission permissions={BasisPermissions.User.ManagePermission}>
            <Button
              type="link"
