...
import MenuItemForm, { type ModalRef } from './-MenuItemForm';
...
export const Route = createFileRoute('/admin/menus/$appName')({
    component: MenuTable,
});
...
function MenuTable() {
    ...
    const columns: SmartTableColumnType<IMenuItemListOutput>[] = [
        {
            title: '菜单名称',
            dataIndex: 'title',
            key: 'title',
    ...
    const handleTabChange = (key: string) => {
        navigate({ to: '/admin/menus/$appName', params: { appName: key } });
    };
