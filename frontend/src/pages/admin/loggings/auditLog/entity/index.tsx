...
export const Route = createFileRoute('/admin/loggings/auditLog/entity/')({
    component: EntityChangeLogList,
});
...
function EntityChangeLogList() {
    const navigate = useNavigate();

    // 查看详情
    const handleViewDetails = (id: string) => {
        navigate({ to: '/admin/loggings/auditLog/entity/$id', params: { id } });
    };

    const columns: SmartTableColumnType<EntityChangeLogDto>[] = [
        {
            title: '变更时间',
