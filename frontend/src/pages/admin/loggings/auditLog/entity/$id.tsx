...
export const Route = createFileRoute('/admin/loggings/auditLog/entity/$id')({
    component: EntityChangeLogDetails,
});
...
function EntityChangeLogDetails() {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                if (id) {
                    setLoading(true);
                    const data = await getEntityChangeLogDetails(id);
                    setDetails(data);
                }
            } catch (error) {
